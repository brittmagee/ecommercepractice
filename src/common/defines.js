  ...
  category: [
    {
      ...
      sub: [
        ...
        { name: "tanks", iconClass: "icon-pant" },
        { name: "long sleeves", iconClass: "icon-short" },
        { name: "hoodie", iconClass: "icon-jacket" },
        { name: "prints", iconClass: "icon-suit" },
        { name: "stickers", iconClass: "icon-dress" },
      ],
    },
    {
      name: "books",
